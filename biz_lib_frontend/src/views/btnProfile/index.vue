    ...
    <SheetContent side="left" class="w-auto min-w-[480px]">
      ...
      <div class="bizyair-profile-primary-box">
        <div class="bizyair-profile-primary" style="display: flex; align-items: center">
          ...
          <input v-else class="margin-left-10" id="bizyair-profile-share-id-edit" v-model="info.share_id"
        ...
        <div class="bizyair-profile-operate">
          ...
          <vTooltips :tips="'Copy'">
            <span>
              <span v-clipboard:copy="info.share_id" v-clipboard:success="onCopySuccess" v-clipboard:error="onCopyError" class="bizyair-icon-operate bizyair-icon-copy"></span>
            </span>
          </vTooltips>
        </div>
        <button v-clipboard:copy="'aaaaaaa'">111</button>
      </div>
    </SheetContent>
  </Sheet>
</template>
