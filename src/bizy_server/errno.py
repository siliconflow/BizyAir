...
FILE_UPLOAD_SIZE_LIMIT_ERR = ErrorNo(413, 413000, None, "File size exceeds the allowed limit. Please use the \"--client_max_size option\" to specify the upload file size limit, default is 10MB.")
