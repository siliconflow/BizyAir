...
- [2024/08/05] 🌩️ BizyAir JoyCaption node has been released. [Try the example to recreate a image by JoyCaption + Flux](./examples/bizyair_flux_joycaption_img2img_workflow.json) thanks [fancyfeast/joy-caption-pre-alpha](https://huggingface.co/spaces/fancyfeast/joy-caption-pre-alpha)
